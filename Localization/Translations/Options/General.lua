...
local generalOptionsLocales = {
    ...
    ["Config Tracking Icons"] = {
        ...
        ["deDE"] = "Tracking Icons konfigurieren","Permet de sélectionner les icônes de suivi (comme la boîte aux lettres, les PNJ de réparation) à afficher sur la carte et la mini-carte.",
        ["koKR"] = "추적 아이콘 설정",
        ["esMX"] = "Configurar iconos de rastreamiento",
        ["enUS"] = true,
        ["zhCN"] = "显示NPC图标配置",
        ["zhTW"] = nil,
        ["esES"] = "Configurar iconos de rastreamiento",
    ...
    ["Allows to select which the tracking icons (like Mailbox, Repair-NPCs) to show on the map and minimap."] = {
        ...
        ["esMX"] = "Permite seleccionar qué iconos de rastreamiento (como Buzón, PNJ de Reparación) se mostrarán en el mapa y el minimapa.",
        ["enUS"] = true,
        ["zhCN"] = "允许在地图和小地图上显示选择的NPC图标（例如“邮箱”，“修理”）。",
        ["zhTW"] = nil,
        ["esES"] = "Permite seleccionar qué iconos de rastreamiento (como Buzón, PNJ de Reparación) se mostrarán en el mapa y el minimapa.",
    ...
    ["Enable manual minimum level offset instead of the automatic GetQuestGreenLevel function."] = {
        ...
        ["enUS"] = true,
        ["zhCN"] = "启用手动最小等级补偿，而不是自动获取绿色任务等级的功能.",
    ...
    ["Toggles the width of the quest log window to single or double width. This will also reload the UI."] = {
        ["ptBR"] = nil,
        ["ruRU"] = nil,
        ["deDE"] = nil,
        ["koKR"] = nil,
    ...
    ["Toggles the display of the level requirement badges in the quest log."] = {
        ["ptBR"] = nil,
        ["ruRU"] = nil,
        ["deDE"] = nil,
        ["koKR"] = nil,
